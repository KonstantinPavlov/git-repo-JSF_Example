...
/**
 * Created by Konstantin on 16.09.2016.
 *
 *
 *
 */
...
public class MainBean {
    ...
    public void showMessage()
    {
        ...
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,"Всплываюее окно","GrowlMessage"));
